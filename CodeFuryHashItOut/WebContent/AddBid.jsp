<%@ page language="java" import="com.demo.dao.*,java.sql.*"
...
<script>
	function validateform() {
		...
		console.log(minbid);
		console.log('Wallet amount in validate form :' + walletamt);
...
<body>
	...
	getWalletAmount = con.prepareStatement("select walletamount from user where userid='" + buyerid + "'");
	double walletamt = 0.0;
	ResultSet rs = getWalletAmount.executeQuery();
	while (rs.next())
		walletamt = Double.parseDouble(rs.getString(1));
	System.out.println("Wallet amount in addbid.jsp is : " + walletamt);
	%>
