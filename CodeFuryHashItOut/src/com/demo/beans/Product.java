...
public class Product {
	...
	public Product(String name, int quantity, int cid, double actualPrice, String description, String image) {
		super();
	...
	public Product(String name, int quantity, int sellerID, int cid, double actualPrice, String description,
			String image) {
		super();
