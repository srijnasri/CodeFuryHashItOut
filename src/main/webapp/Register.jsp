...
<input type="text" name="fullname"  placeholder="  Full Name..." id="text1" minlength="3" maxlength="30" required>
<label class="label2">Date of Birth</label>
<input type="date" name="dob"  id="dob1" min="2010-01-01" placeholder="  Date in YYYY-MM-DD..." required>
<label class="label3">Email</label>
<input type="email" name="mail"  id="mail1"  pattern="^[a-z0-9]\.[a-z]{2,3}+$"  placeholder="  Email..." maxlength="30" required>
<label class="label4">Phone No.</label>
<input type="tel" name="phone"  pattern="^[6-9]{1}[0-9]{0,9}$" title="Number must start from 6,7,8,9 only" id="phone1" min="1" placeholder="  Mobile No..." maxlength="10" required>
<label class="label5">Username</label>
<input type="text" name="uname"  id="uname1" placeholder="  UserName..." minlength="3" maxlength="30" required>
<label class="label6">Password</label>
<input type="password" name="pass"  id="pass1" placeholder="  Password..." minlength="4" maxlength="15" onkeyup="validatePass()" required><div id="result"></div>
<label class="label7">Confirm<br>Password</label>
<input type="password" name="cpass"  id="cpass1" placeholder="  Re-type Password..." minlength="4" maxlength="15" onkeyup="validateCPass()" required><div id="result1"></div>
<label class="label8">Address</label>
<input type="text" name="address"  id="address1"  minlength="5" placeholder="  Address (Optional)..." maxlength="100">
<label class="label9">Type of User</label>
<input type="radio" name="radio1"  id="radio11"  required>
<label class="label91">Buyer</label>
<input type="radio" name="radio1"  id="radio22" required>
<label class="label92">Seller</label>
<label class="label10">Wallet<br>Amount</label>
<input type="number" name="money"  id="money1" placeholder="  Amount in Rs. (Optional)..." minlength="4" maxlength="10" min=500>
<input type="submit" na me="btn" id="login-btn" value="Register Here" onclick="check()">
</form>
<div>
</body>
</html>